...
def main():
    ...
    parser.add_argument('--tacotron_train_steps', type=int, default=400000,
    ...
    parser.add_argument('--fine_tuning', default=False, help='fine-tuning model after pretraining model')
    ...
    if args.fine_tuning:
        # warning: ensure you have pretrained model
        # reduce learning_rate
        hparams.tacotron_initial_learning_rate = hparams.tacotron_initial_learning_rate / 10.
        hparams.tacotron_final_learning_rate = hparams.tacotron_final_learning_rate / 10.
        # set test_batches to 1
        hparams.tacotron_test_size = None
        hparams.tacotron_test_batches = 1
